...
class MockerTestCaseTest(TestCase):
    ...
    def test_missing_python23_aliases(self):
        self.assertEquals(MockerTestCase.assertTrue.__func__,
                          MockerTestCase.failUnless.__func__)

        self.assertEquals(MockerTestCase.assertFalse.__func__,
                          MockerTestCase.failIf.__func__)
...
class MockerTest(TestCase):
    ...
    def test_replace_with_bound_method(self):
        ...
        self.assertEquals(mock.__mocker_object__, Queue.empty.__func__)
...
class RunCounterTest(TestCase):
    ...
    def test_create_unbounded(self):
        ...
        self.assertEquals(task.min, 2)
        self.assertEquals(task.max, sys.maxsize)
